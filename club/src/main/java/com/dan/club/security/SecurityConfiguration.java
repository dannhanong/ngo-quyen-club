...
import com.dan.club.security.jwt.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(
            config->config
                ...
                .requestMatchers(HttpMethod.POST, Endpoints.TEACHER_POST_ENDPOINTS).hasAuthority("TEACHER")
                .requestMatchers(HttpMethod.GET, Endpoints.TEACHER_DELETE_ENDPOINTS).hasAuthority("TEACHER")
                .requestMatchers(HttpMethod.PUT, Endpoints.TEACHER_PUT_ENDPOINTS).hasAuthority("TEACHER")
